...
const RAW: Array<{
  ...
  },
  {
    ...
    name: "Ресторан",
    category: "food",
    keywords: ["ресторан", "кухн", "меню", "restaurant", "банкет"],
    brand: "Nord Kitchen",
  ...
  },
  {
    ...
    name: "Магазин мебели",
    category: "shop",
    keywords: ["мебел", "мебель", "диван", "кухн", "шкаф", "стуль"],
    brand: "Home Soft",
    headline: "Мебель под ваш интерьер",
    sub: "Каталог, материалы и расчёт под размеры.",
    cta: "Получить расчёт",
    services: ["На заказ", "Для дома", "Для бизнеса"],
    accent: "#0ea5e9",
  },
  {
    id: "cafe",
    name: "Сайт для кафе",
    category: "food",
    keywords: ["кафе", "кофейн", "coffee", "чайная", "пекарн"],
    brand: "Daily Cup",
    headline: "Кофе и атмосфера",
    sub: "Меню, локация и бронирование столика.",
    cta: "Забронировать",
    services: ["Меню", "Завтраки", "Мероприятия"],
    accent: "#c2410c",
  },
  {
    id: "realty",
